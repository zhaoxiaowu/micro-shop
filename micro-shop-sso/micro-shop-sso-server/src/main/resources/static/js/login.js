$(function () {
    ...
    var forgeClick = function () {
        var accountForgetBtn = $("button[data-btn='account-forget-btn']");
        accountForgetBtn.unbind("click");
        accountForgetBtn.click(function (e) {
            e.preventDefault;
    ...
    // $("form button.fromSubmit").click(function (e) {
    //
    ...
    //     });
    // });
    var smsSubmitClick = function () {
        var smsSubmit = $("button[data-type='smsSubmit']");
        smsSubmit.unbind("click");
        smsSubmit.click(function (e) {
            e.preventDefault();
            alert("123");
        });
    }
    var accountSubmitClick = function () {
        var accountSubmit = $("button[data-type='accountSubmit']");
        accountSubmit.unbind("click");
        accountSubmit.click(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.errorCode == 0) {
                        var redirect = data.returnObject.redirectUrl;
                        var jwt = data.returnObject.jwt;
                        if (redirect) {
                            location.href = redirect + "?jwt=" + jwt;
                        }else {
                            alert("登陆成功")
                            $("#errorMsg").text = "登陆成功";
                        }
